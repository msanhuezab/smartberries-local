...
include_once __DIR__ . '/../../assest/config/cronPtHelper.php';

include_once __DIR__ . '/../../assest/controlador/EMPRESA_ADO.php';
include_once __DIR__ . '/../../assest/controlador/TEMPORADA_ADO.php';
...
<head>
  ...
  <title>Selección Configuración - Volcan Foods</title>
...
if (isset($_REQUEST['ENTRAR'])) {
    ...
    $AUSUARIO_ADO->agregarAusuario2('NULL',3,0,"".$_SESSION["NOMBRE_USUARIO"].", Inicio Sesión, Selección","usuario_usuario",$_SESSION["ID_USUARIO"],$_SESSION["ID_USUARIO"],$_REQUEST["EMPRESA"],'NULL',$_REQUEST['TEMPORADA'] );            
    header('Location: index.php');
    exit;
}
