                                        ...
                                        <tbody>
                                            <?php foreach ($ARRAYCONTROLES as $control) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo recepcionTexto($control["MODO_INGRESO"]); ?></td>
                                                    <td><?php echo recepcionTexto($control["MODO_INGRESO"] === "AGRUPADO" ? "Recepcion completa" : $control["FOLIOS"]); ?></td>
                                                    <td><?php echo recepcionTexto($control["NOMBRE_INSPECTOR"]); ?></td>
                                                    <td class="text-center"><strong><?php echo recepcionTexto($control["RESULTADO_GENERAL"]); ?></strong></td>
                                                    <td class="text-right"><?php echo recepcionTexto($control["PORC_DEFECTO_CONDICION"]); ?></td>
                                                    <td class="text-right"><?php echo recepcionTexto($control["PORC_DEFECTO_CALIDAD"]); ?></td>
                                                    <td class="text-right"><?php echo recepcionTexto($control["PORC_FIRMEZA"]); ?></td>
                                                    <td class="text-right"><?php echo recepcionTexto($control["PORC_ESTIMADO_EXPORTACION"]); ?></td>
                                                    <td class="text-center">
                                                        <?php if ($control["ESTADO_CONTROL"] === "CERRADO") { ?>
                                                            <?php echo recepcionTexto($control["FECHA_CIERRE"]); ?>
                                                        <?php } else { ?>
                                                            <button type="button" class="btn btn-rounded btn-warning btn-sm editar-control-calidad"
                                                                data-toggle="modal"
                                                                data-target="#modalControlCalidad"
                                                                data-id="<?php echo recepcionTexto($control["ID_CALIDAD_CONTROL"]); ?>">
                                                            ...
                                                            <button type="button" class="btn btn-rounded btn-success btn-sm cerrar-control-calidad"
                                                                ...
                                                                data-id="<?php echo recepcionTexto($control["ID_CALIDAD_CONTROL"]); ?>"
                                                                data-resolucion="<?php echo recepcionTexto($control["RESULTADO_GENERAL"]); ?>"
                                                                data-exportacion="<?php echo recepcionTexto($control["PORC_ESTIMADO_EXPORTACION"]); ?>">
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($control["ESTADO_CONTROL"] === "CERRADO") { ?>
                                                            <button type="button" class="btn btn-rounded btn-danger btn-sm"
                                                                onclick="window.open('../../assest/documento/informeCalidadRecepcion.php?parametro=<?php echo recepcionTexto($control["ID_CALIDAD_CONTROL"]); ?>&usuario=<?php echo recepcionTexto($IDUSUARIOS); ?>', '_blank');">
