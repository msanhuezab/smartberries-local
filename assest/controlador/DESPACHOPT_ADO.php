...
class DESPACHOPT_ADO
{
    ...
    public function verDespachoptLista($IDLISTA)
    {
        try {
    ...
    public function verDespachopt2($ID, $EMPRESA = null)
{
    try {
    ...
    public function listarDespachoptEmpresaPlantaTemporadaGuiaCBXEstadoDespacho($EMPRESA, $PLANTA, $TEMPORADA)
    {
        try {
            ...
            $datos = $this->conexion->prepare("SELECT * ,
                                                    ...
                                                    IFNULL(KILOS_BRUTO_DESPACHO,0)  AS 'BRUTO' 
                                                FROM fruta_despachopt                                                                           
                                                WHERE ESTADO_REGISTRO IN (1,0)                                                                                                        
                                                AND TDESPACHO = 1
                                                AND ESTADO_DESPACHO IN (1,2,3,4)
                                                AND ID_EMPRESA = '" . $EMPRESA . "' 
                                                AND ID_PLANTA2 = '" . $PLANTA . "'
                                                AND ID_TEMPORADA = '" . $TEMPORADA . "' ;	");
            $datos->execute();
