...
<head>
    ...
    <!- FUNCIONES BASES -!>
        <script type="text/javascript">
            ...
            function aplicarSelectPresupuesto(id, valor) {
            ...
            function cargarCondicionesPresupuesto() {
                var mercado = document.getElementById('MERCADO') ? document.getElementById('MERCADO').value : '';
                var consignatario = document.getElementById('CONSIGNATARIO') ? document.getElementById('CONSIGNATARIO').value : '';
                if (!mercado || !consignatario) {
                    return;
                }

                fetch('ajaxPresupuestoFob.php?accion=comercial&mercado=' + encodeURIComponent(mercado) + '&consignatario=' + encodeURIComponent(consignatario))
                    .then(function (response) { return response.json(); })
                    .then(function (data) {
                        if (!data.ok) {
                            return;
                        }
                        aplicarSelectPresupuesto('MVENTA', data.id_mventa);
                        aplicarSelectPresupuesto('CVENTA', data.id_cventa);
                        aplicarSelectPresupuesto('TFLETE', data.id_tflete);
                    })
                    .catch(function () {});
            }

            document.addEventListener('DOMContentLoaded', function () {
                ['MERCADO', 'CONSIGNATARIO'].forEach(function (id) {
                    var el = document.getElementById(id);
                    if (el) {
                        el.addEventListener('change', cargarCondicionesPresupuesto);
                    }
                });
            });
        </script>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-3 col-xl-5 col-lg-9 col-md-9 col-sm-9 col-9 col-xs-9">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" id="CONSIGNATARIO" name="CONSIGNATARIO" style="width: 100%;" onchange="cargarCondicionesPresupuesto()" <?php echo $DISABLED; ?>>
                                                        <option></option>
                                            ...
                                            <div class="col-xxl-3 col-xl-5 col-lg-9 col-md-9 col-sm-9 col-9 col-xs-9">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" id="MERCADO" name="MERCADO" style="width: 100%;" value="<?php echo $MERCADO; ?>" onchange="cargarCondicionesPresupuesto()" <?php echo $DISABLED; ?>>
                                                        <option></option>
        ...
        <?php
            ...
            if (isset($_REQUEST['CERRAR'])) {
                ...
                if ($SINO == "0") {
                    ...
                    $ICARGA->__SET('ID_ICARGA', $_REQUEST['IDP']);
                    // Deja el instructivo disponible para liquidacion/pago.
