...
$ARRAYTITEM = $TITEM_ADO->listarTitemPorEmpresaLiquidacionTodosCBX($EMPRESAS);





//OBTENCION DE DATOS ENVIADOS A LA URL
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="TIPOGASTO" name="TIPOGASTO" <?php echo $DISABLED; ?>>
                                                            <option value="GASTO" <?php echo $TIPOGASTO === 'GASTO' ? 'selected' : ''; ?>>Gasto destino</option>
                                                            <option value="COMISION" <?php echo $TIPOGASTO === 'COMISION' ? 'selected' : ''; ?>>Comision</option>
                                                            <option value="FLETE" <?php echo $TIPOGASTO === 'FLETE' ? 'selected' : ''; ?>>Flete</option>
                                                            <option value="OTRO" <?php echo $TIPOGASTO === 'OTRO' ? 'selected' : ''; ?>>Otro</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($ARRAYTITEM as $r) : ?>
                                                        ...
                                                        <tr class="center">
                                                            ...
                                                            <td><?php echo $r['TIPO_GASTO'] ?? 'GASTO'; ?></td>   
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        <?php 
            ...
            if (isset($_REQUEST['GUARDAR'])) {
                ...
                $TITEM->__SET('TIPO_GASTO', $_REQUEST['TIPOGASTO'] ?? 'GASTO');
